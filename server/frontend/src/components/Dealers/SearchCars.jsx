            ...
            <div id="main">
                <div style={{ margin: "0px" }}>
                    ...
                    <div style={{ marginLeft: "5%", marginRight: '5%' }}>
                        <h1 style={{ marginBottom: '20px', textAlign: 'center' }}>Cars at {dealer.full_name}</h1>
                        <div className='row gtr-uniform'>
                            <div className='col-3 col-12-xsmall'>
                                <span style={{ marginLeft: '10px', paddingLeft: '10px' }}>Make</span>
                                <select style={{ marginLeft: '10px', paddingLeft: '10px', borderRadius: '10px' }} name="make" id="make" onChange={SearchCarsByMake}>
                                    {makes.length === 0 ? (
                                ...
                                <select style={{ marginLeft: '10px', paddingLeft: '10px', borderRadius: '10px' }} name="model" id="model" onChange={SearchCarsByModel}>
                                    {models.length === 0 ? (
                                        <option value=''>No data found</option>
                                    ) : (
                                        <>
                                ...
                                <select style={{ marginLeft: '10px', paddingLeft: '10px', borderRadius: '10px' }} name="year" id="year" onChange={SearchCarsByYear}>
                            ...
                            <div className='col-3 col-12-xsmall'>
                                ...
                                <select style={{ marginLeft: '10px', paddingLeft: '10px', borderRadius: '10px' }} name="mileage" id="mileage" onChange={SearchCarsByMileage}>
                                    <option selected value='all'> -- All -- </option>
                                ...
                                <select style={{ marginLeft: '10px', paddingLeft: '10px', borderRadius: '10px' }} name="price" id="price" onChange={SearchCarsByPrice}>
                                    <option selected value='all'> -- All -- </option>
                                ...
                                <br />
                                <button style={{ marginLeft: '10px' }} onClick={reset} className='homepage_links button primary solid'>Reset</button>
                            </div>
                        </div>
                                ...
                                <div className='row'>
                                    ...
                                    {cars.map((car) => (
                                        <div className='col-3 col-12-medium'>
                                            <div className='box' style={{backgroundColor: 'rgba(255, 255, 255, 0.7)'}}>
                                                <div key={car._id}>
