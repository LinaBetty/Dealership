  ...
  return (
    <div id="wrapper">
      <div id="main">
        <div>
          <Header />
          <div className='table-wrapper'style={{padding: '3%'}}>
            <table className='table'>
              <tr>
                ...
                <th>Zip</th>
                <th>
                  <input style={{marginTop: '3%'}} type="text" placeholder="Search states..." onChange={handleInputChange} onBlur={handleLostFocus} value={searchQuery} />
